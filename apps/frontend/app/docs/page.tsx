...
import SimulatorEngine from "./sections/SimulatorEngine";
import DataFlow from "./sections/DataFlow";
import FrontendVisualization from "./sections/FrontendVisualization";
import Observability from "./sections/Observability";

const CARDS = [
  {
    title: "Architecture",
    description: "System design, tech stack, and deployment topology.",
    href: "#architecture",
    icon: (
  ...
  {
    title: "API Reference",
    description: "WebSocket and REST endpoints with example payloads.",
    href: "#api-reference",
    icon: (
      <svg className="w-5 h-5 text-white/80" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
  ...
  {
    title: "Visualization",
    description: "Mapbox layers, phase colors, and sprite rendering.",
    href: "#frontend-viz",
    icon: (
      <svg className="w-5 h-5 text-white/80" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
  ...
  {
    title: "Observability",
    description: "Traces, metrics, logs, and service topology.",
    href: "#observability",
    icon: (
      <svg className="w-5 h-5 text-white/80" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
