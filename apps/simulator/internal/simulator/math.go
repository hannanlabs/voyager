...
func CalculateBearing(from, to FlightPosition) float64 {
...
func CalculateDistance(from, to FlightPosition) float64 {
	lat1 := from.Latitude * math.Pi / 180
	lat2 := to.Latitude * math.Pi / 180
...
func InterpolatePosition(from, to FlightPosition, progress float64) FlightPosition {
...
func SpeedToVelocity(speed, bearing float64) FlightVelocity {
